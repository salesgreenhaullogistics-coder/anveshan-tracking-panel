...
const PAGE_MAP = {
  ...
  prepull: PrepullAged, 'aging-monitor': AgingMonitor, 'morning-call': MorningCall, 'command-center': CommandCenter, delivered: Delivered, return: ReturnModule,
  pods: PODs, grn: GRN, kpi: KPIMatrix, okr: OKR,
  cost: LogisticsCost, analytics: Analytics, 'shopify-analytics': ShopifyAnalytics, poc: POCDetails, sop: PlatformSOP, provision: Provision,
};
...
const TAB_TITLES = {
  ...
  prepull: 'Prepull Aged', 'aging-monitor': 'Aging Monitor', 'morning-call': 'Morning Logistics Call', 'command-center': 'Command Center', delivered: 'Delivered', return: 'Return',
  pods: 'PODs', grn: 'GRN Control Center', kpi: 'KPI Matrix', okr: 'OKR',
  cost: 'Logistics Cost', analytics: 'Analytics', 'shopify-analytics': 'Shopify Analytics', poc: 'POC Details', sop: 'Platform SOP', provision: 'Provision & Billing',
};
